...
with open(FLAGS.dictionary, encoding='utf-8') as dic:
    dictionary = json.load(dic, encoding='utf-8')

with open(FLAGS.reversed_dictionary, encoding='utf-8') as r_dic:
    reversed_dictionary = json.load(r_dic, encoding='utf-8')
